#####################################################
#	Algoritmo de prediccion de bunching usando MPH	#
...
# IDs, frecuencias = numpy.unique([:,0], return_counts=True)
...
for dia in fechasVentana:
	for finVentana in range(inicioPruebas*3600, finPruebas*3600, 1800):
		...
		if len(lista_ids)>1:
			...
			# print('Cantidad de viajes en dataset paraderos: {}'.format(len(dataset)))
